...
if __name__ == '__main__':
    ...
    for offset, fileinfo in mbdb.items():
        ...
        retstr = fileinfo_str(fileinfo, verbose)
	if re.search("consolidated", retstr):
		dbname = re.findall("\((.*?)\)", retstr);
		print "Your iPhone database is located in file: %s" % dbname[0]
		print "Execute the following command:\n"
		print "./iPhoneMap.pl myIphone %s" % dbname[0]
